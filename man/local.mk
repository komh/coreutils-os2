...
man/sha1sum.1:   src/md5sum$(EXEEXT)
man/sha224sum.1: src/md5sum$(EXEEXT)
man/sha256sum.1: src/md5sum$(EXEEXT)
man/sha384sum.1: src/md5sum$(EXEEXT)
man/sha512sum.1: src/md5sum$(EXEEXT)
